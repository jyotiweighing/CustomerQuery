...
export default function Sidebar({ open, onClose }) {
  ...
  const handleLogout = () => {
    // LocalStorage se specific keys remove ho jayengi
      ...
      >
        ...
        <div className="relative z-10 p-2 border-t border-white/50">
          <button
            ...
            className="w-full flex items-center gap-4 px-4 py-3 rounded-xl text-white/90 hover:bg-red-500/20 hover:text-white transition-all text-left"
          >
            <LogOut size={18} />
            Logout
          </button>
